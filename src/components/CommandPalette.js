export class CommandPalette {
  constructor(appContext) {
    ...
    this.commands = [
      ...
      { cmd: '/morph tesseract', desc: 'Morph particle cloud to 4D Hypercube Tesseract', action: () => this.app.scene.setMorphTarget('tesseract') },
      { cmd: '/tesseract', desc: 'Morph particle cloud to 4D Hypercube Tesseract', action: () => this.app.scene.setMorphTarget('tesseract') },
      { cmd: '/game', desc: 'Engage Protocol: Quantum Resonance puzzle mode', action: () => this.app.game?.toggle() },
      { cmd: '/puzzle', desc: 'Engage Protocol: Quantum Resonance puzzle mode', action: () => this.app.game?.toggle() },
